...
public class UW : MonoBehaviour
{
    ...
    public void UseUltimate()
    {
        if (bossGameObject != null)
        {
            ...
            UEW uEW = ultimateInstance.GetComponent<UEW>();
            if (uEW != null)
            {
                BossHealthWolf bossHealthW = bossGameObject.GetComponent<BossHealthWolf>();
                uEW.Initialize(bossHealthW, ultimateDamage);
                uEW.ActivateUltimateEffect();
            }
