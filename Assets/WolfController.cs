...
public class WolfController : MonoBehaviour
{
    ...
    private Collider2D wolfCollider; // Reference to the rat's collider
    ...
    void Start()
    {
        ...
        wolfCollider = GetComponent<Collider2D>(); // Get the Collider2D component attached to the rat
    ...
    private void Die()
    {
        if (!isKilled)
        {
            ...
            boss1.KillWolf(); // Notify the boss
    ...
    private IEnumerator EnableColliderAfterDelay(float delay)
    {
        ...
        wolfCollider.enabled = true; // Re-enable the collider after the delay
