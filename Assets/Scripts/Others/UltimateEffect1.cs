...
public class UltimateEffect1 : MonoBehaviour
{
    private BossHealthTim bossHealth; // Reference to the BossHealthTim script
    ...
    public void Initialize(BossHealthTim bossHealth, float ultimateDamage)
    {
